...
RSpec.describe Game, type: :model do
  ...
  context 'game mechanics' do
    ...
    # Задача 61-3 : Напишите тест на метод take_money
  ...
  # Задача 61-4 : Напишите группу тестов на метод .status
  ...
  context '.status' do
    ...
    # Задача 61-6 : Напишите тесты на методы current_game_question и previous_level
  ...
  # Задача 61-7 : Напишите группу тестов на метод answer_current_question
  ...
  context '.answer_current_question' do
    ...
    context '1000000 question' do
      it 'updates game status to won and finishes the game' do
    ...
    context 'answer after timeout' do
      it 'checks current time and finishes the game' do
